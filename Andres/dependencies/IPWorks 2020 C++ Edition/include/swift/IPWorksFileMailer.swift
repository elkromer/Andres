...
public enum FilemailerAuthMechanisms : Int32 {
...
public enum FilemailerFirewallTypes : Int32 {
  case fwNone = 0
  case fwTunnel = 1
  case fwSOCKS4 = 2
  case fwSOCKS5 = 3
}
public enum FilemailerImportances : Int32 {
  case miUnspecified = 0
  case miHigh = 1
  case miNormal = 2
  case miLow = 3
}
public enum FilemailerMessageRecipientTypes : Int32 {
  case rtTo = 0
  case rtCc = 1
  case rtBCc = 2
}
public enum FilemailerPriorities : Int32 {
  case epUnspecified = 0
  case epNormal = 1
  case epUrgent = 2
  case epNonUrgent = 3
}
public enum FilemailerSensitivities : Int32 {
  case esUnspecified = 0
  case esPersonal = 1
  case esPrivate = 2
  case esCompanyConfidential = 3
}
public enum FilemailerSSLCertStoreTypes : Int32 {
  case cstUser = 0
  case cstMachine = 1
  case cstPFXFile = 2
  case cstPFXBlob = 3
...
public enum FilemailerSSLStartModes : Int32 {
  case sslAutomatic = 0
  case sslImplicit = 1
  case sslExplicit = 2
  case sslNone = 3
...
public protocol IPWorksFileMailerDelegateSwift {
...
public enum IPWorksFileMailerError : Error {
  case Error(Int32, String)
}

public class IPWorksFileMailerSwift : NSObject, IPWorksFileMailerDelegate {
  public var m_obj: IPWorksFileMailer
  var m_delegate: IPWorksFileMailerDelegateSwift?

  override init() {
    self.m_obj = IPWorksFileMailer()
    self.m_delegate = nil
    super.init()
  ...
  public var delegate: IPWorksFileMailerDelegateSwift? {
    get {
      return m_delegate
    }
    set {
  ...
  public func attachmentFile(attachmentIndex: Int32) throws -> String {
    ...
    if (m_obj.lastErrorCode() != 0) { throw IPWorksFileMailerError.Error(m_obj.lastErrorCode(), m_obj.lastError()) }
    return unwrapNSString(ret)
  }
  ...
  public var authMechanism: FilemailerAuthMechanisms {
    get {
      return FilemailerAuthMechanisms(rawValue: m_obj.authMechanism)!
    }
    set {
  ...
  public var firewallType: FilemailerFirewallTypes {
    get {
      return FilemailerFirewallTypes(rawValue: m_obj.firewallType)!
    }
    set {
  ...
  public var importance: FilemailerImportances {
    get {
      return FilemailerImportances(rawValue: m_obj.importance)!
    }
    set {
  ...
  public func messageRecipientType(recipientIndex: Int32) throws -> FilemailerMessageRecipientTypes {
    let ret = FilemailerMessageRecipientTypes(rawValue: m_obj.messageRecipientType(recipientIndex))!
    if (m_obj.lastErrorCode() != 0) { throw IPWorksFileMailerError.Error(m_obj.lastErrorCode(), m_obj.lastError()) }
    return ret
  }

  public func setMessageRecipientType(recipientIndex: Int32, newMessageRecipientType: FilemailerMessageRecipientTypes) throws -> Void {
  ...
  public var priority: FilemailerPriorities {
    get {
      return FilemailerPriorities(rawValue: m_obj.priority)!
    }
    set {
  ...
  public var sensitivity: FilemailerSensitivities {
    get {
      return FilemailerSensitivities(rawValue: m_obj.sensitivity)!
    }
    set {
  ...
  public var SSLCertStoreType: FilemailerSSLCertStoreTypes {
    get {
      return FilemailerSSLCertStoreTypes(rawValue: m_obj.SSLCertStoreType)!
    }
    set {
  ...
  public var SSLStartMode: FilemailerSSLStartModes {
    get {
      return FilemailerSSLStartModes(rawValue: m_obj.SSLStartMode)!
    }
    set {
