...
public protocol IPWorksUDPPortDelegateSwift {
...
public enum IPWorksUDPPortError : Error {
  case Error(Int32, String)
}

public class IPWorksUDPPortSwift : NSObject, IPWorksUDPPortDelegate {
  public var m_obj: IPWorksUDPPort
  var m_delegate: IPWorksUDPPortDelegateSwift?

  override init() {
    self.m_obj = IPWorksUDPPort()
    self.m_delegate = nil
    super.init()
  ...
  public var delegate: IPWorksUDPPortDelegateSwift? {
    get {
      return m_delegate
    }
    set {
  ...
  public func config(_ configurationString: String) throws -> String {
    ...
    if (m_obj.lastErrorCode() != 0) { throw IPWorksUDPPortError.Error(m_obj.lastErrorCode(), m_obj.lastError()) }
    return unwrapNSString(ret)
  }
