...
public enum RshellFirewallTypes : Int32 {
  case fwNone = 0
  case fwTunnel = 1
  case fwSOCKS4 = 2
  case fwSOCKS5 = 3
...
public protocol IPWorksRshellDelegateSwift {
...
public enum IPWorksRshellError : Error {
  case Error(Int32, String)
}

public class IPWorksRshellSwift : NSObject, IPWorksRshellDelegate {
  public var m_obj: IPWorksRshell
  var m_delegate: IPWorksRshellDelegateSwift?

  override init() {
    self.m_obj = IPWorksRshell()
    self.m_delegate = nil
    super.init()
  ...
  public var delegate: IPWorksRshellDelegateSwift? {
    get {
      return m_delegate
    }
    set {
  ...
  public var firewallType: RshellFirewallTypes {
    get {
      return RshellFirewallTypes(rawValue: m_obj.firewallType)!
    }
    set {
  ...
  public var localUser: String {
    get {
      let ret: String? = String(m_obj.localUser)
      return unwrapNSString(ret)
    }
    set {
      m_obj.localUser = newValue as NSString
    }
  }
  ...
  public func config(_ configurationString: String) throws -> String {
    ...
    if (m_obj.lastErrorCode() != 0) { throw IPWorksRshellError.Error(m_obj.lastErrorCode(), m_obj.lastError()) }
    return unwrapNSString(ret)
  }
