...
extern "C" void* IPWORKS_CALL IPWorks_REST_Get(void *lpObj, int propid, int arridx, int *lpcbVal, int64 *lpllVal);
extern "C" int   IPWORKS_CALL IPWorks_REST_Set(void *lpObj, int propid, int arridx, const void *val, int cbVal);
extern "C" int   IPWORKS_CALL IPWorks_REST_Do(void *lpObj, int methid, int cparam, void *param[], int cbparam[], int64 *lpllVal);
...
class REST {
  ...
  protected:
    ...
    static int IPWORKS_CALL RESTEventSink(void *lpObj, int event_id, int cparam, void *param[], int cbparam[]) {
      ...
      switch (event_id) {
        ...
        case 10: {
          RESTEvalEntityEventParams e = {(char*)IPW64CAST(param[0]), (char*)IPWorks_EvtStr(param[1], 0, NULL, 1), 0};
        ...
        case 19: {
          RESTSSLServerAuthenticationEventParams e = {(char*)IPW64CAST(param[0]), (int)IPW64CAST(cbparam[0]), (char*)IPW64CAST(param[1]), (char*)IPW64CAST(param[2]), (char*)IPW64CAST(param[3]), (int)IPW64CAST(param[4]), 0};
        ...
        case 25: {
          RESTTransferEventParams e = {(int)IPW64CAST(param[0]), *(int64*)IPW64CAST(param[1]), (int)IPW64CAST(param[2]), (char*)IPW64CAST(param[3]), (int)IPW64CAST(cbparam[3]), 0};
  ...
  public:
    REST(char *lpOemKey = (char*)IPWORKS_OEMKEY_34) {
      m_pObj = IPWorks_REST_Create(RESTEventSink, (void*)this, (char*)lpOemKey, 0);
#ifdef WIN32
    ...
    inline char *VERSION() {
      return (char*)IPWorks_REST_Get(m_pObj, 0, 0, NULL, NULL);
    }
    inline char* GetRuntimeLicense() {
      return (char*)IPWorks_REST_Get(m_pObj, 2011, 0, NULL, NULL);
    }
  ...
  public: // Properties
    inline char* GetAccept() {
      void* val = IPWorks_REST_Get(m_pObj, 1, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetAccept(const char* lpszAccept) {
      return IPWorks_REST_Set(m_pObj, 1, 0, (void*)lpszAccept, 0);
    }

    inline char* GetAuthorization() {
      void* val = IPWorks_REST_Get(m_pObj, 2, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetAuthorization(const char* lpszAuthorization) {
      return IPWorks_REST_Set(m_pObj, 2, 0, (void*)lpszAuthorization, 0);
    }

    inline int GetAuthScheme() {
      void* val = IPWorks_REST_Get(m_pObj, 3, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline int GetBuildDOM() {
      void* val = IPWorks_REST_Get(m_pObj, 4, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline int GetConnected() {
      void* val = IPWorks_REST_Get(m_pObj, 5, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline char* GetContentType() {
      void* val = IPWorks_REST_Get(m_pObj, 6, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetContentType(const char* lpszContentType) {
      return IPWorks_REST_Set(m_pObj, 6, 0, (void*)lpszContentType, 0);
    }

    inline int GetCookieCount() {
      void* val = IPWorks_REST_Get(m_pObj, 7, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline char* GetCookieDomain(int iCookieIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 8, iCookieIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetCookieExpiration(int iCookieIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 9, iCookieIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetCookieName(int iCookieIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 10, iCookieIndex, NULL, NULL);
      return (char*)val;
    }
    inline int SetCookieName(int iCookieIndex, const char* lpszCookieName) {
      return IPWorks_REST_Set(m_pObj, 10, iCookieIndex, (void*)lpszCookieName, 0);
    }

    inline char* GetCookiePath(int iCookieIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 11, iCookieIndex, NULL, NULL);
      return (char*)val;
    }

    inline int GetCookieSecure(int iCookieIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 12, iCookieIndex, NULL, NULL);
      return (int)(long)val;
    }

    inline char* GetCookieValue(int iCookieIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 13, iCookieIndex, NULL, NULL);
      return (char*)val;
    }
    inline int SetCookieValue(int iCookieIndex, const char* lpszCookieValue) {
      return IPWorks_REST_Set(m_pObj, 13, iCookieIndex, (void*)lpszCookieValue, 0);
    }

    inline int GetFirewallAutoDetect() {
      void* val = IPWorks_REST_Get(m_pObj, 14, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline int GetFirewallType() {
      void* val = IPWorks_REST_Get(m_pObj, 15, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline char* GetFirewallHost() {
      void* val = IPWorks_REST_Get(m_pObj, 16, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetFirewallHost(const char* lpszFirewallHost) {
      return IPWorks_REST_Set(m_pObj, 16, 0, (void*)lpszFirewallHost, 0);
    }

    inline char* GetFirewallPassword() {
      void* val = IPWorks_REST_Get(m_pObj, 17, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetFirewallPassword(const char* lpszFirewallPassword) {
      return IPWorks_REST_Set(m_pObj, 17, 0, (void*)lpszFirewallPassword, 0);
    }

    inline int GetFirewallPort() {
      void* val = IPWorks_REST_Get(m_pObj, 18, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline char* GetFirewallUser() {
      void* val = IPWorks_REST_Get(m_pObj, 19, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetFirewallUser(const char* lpszFirewallUser) {
      return IPWorks_REST_Set(m_pObj, 19, 0, (void*)lpszFirewallUser, 0);
    }

    inline int GetFollowRedirects() {
      void* val = IPWorks_REST_Get(m_pObj, 20, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline char* GetFrom() {
      void* val = IPWorks_REST_Get(m_pObj, 21, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetFrom(const char* lpszFrom) {
      return IPWorks_REST_Set(m_pObj, 21, 0, (void*)lpszFrom, 0);
    }

    inline char* GetHTTPMethod() {
      void* val = IPWorks_REST_Get(m_pObj, 22, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetHTTPMethod(const char* lpszHTTPMethod) {
      return IPWorks_REST_Set(m_pObj, 22, 0, (void*)lpszHTTPMethod, 0);
    }

    inline int GetIdle() {
      void* val = IPWorks_REST_Get(m_pObj, 23, 0, NULL, NULL);
      return (int)(long)val;
    }

    inline char* GetIfModifiedSince() {
      void* val = IPWorks_REST_Get(m_pObj, 24, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetIfModifiedSince(const char* lpszIfModifiedSince) {
      return IPWorks_REST_Set(m_pObj, 24, 0, (void*)lpszIfModifiedSince, 0);
    }

    inline char* GetLocalFile() {
      void* val = IPWorks_REST_Get(m_pObj, 25, 0, NULL, NULL);
      return (char*)val;
    }
#ifdef WIN32
    inline wchar_t* GetLocalFile_W() {
      void* val = IPWorks_REST_Get(m_pObj, 25+10000, 0, NULL, NULL);
      return (wchar_t*)val;
    }
#endif // WIN32
    inline int SetLocalFile(const char* lpszLocalFile) {
      return IPWorks_REST_Set(m_pObj, 25, 0, (void*)lpszLocalFile, 0);
    }
#ifdef WIN32
    inline int SetLocalFile(const wchar_t* lpszLocalFile) {
      return IPWorks_REST_Set(m_pObj, 25+10000, 0, (void*)lpszLocalFile, 0);
    }
#endif // WIN32

    inline char* GetLocalHost() {
      void* val = IPWorks_REST_Get(m_pObj, 26, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetLocalHost(const char* lpszLocalHost) {
      return IPWorks_REST_Set(m_pObj, 26, 0, (void*)lpszLocalHost, 0);
    }

    inline int GetNamespaceCount() {
      void* val = IPWorks_REST_Get(m_pObj, 27, 0, NULL, NULL);
      return (int)(long)val;
    }

    inline char* GetNamespacePrefix(int iNamespaceIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 28, iNamespaceIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetNamespaceURI(int iNamespaceIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 29, iNamespaceIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetOtherHeaders() {
      void* val = IPWorks_REST_Get(m_pObj, 30, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetOtherHeaders(const char* lpszOtherHeaders) {
      return IPWorks_REST_Set(m_pObj, 30, 0, (void*)lpszOtherHeaders, 0);
    }

    inline int GetParsedHeaderCount() {
      void* val = IPWorks_REST_Get(m_pObj, 31, 0, NULL, NULL);
      return (int)(long)val;
    }

    inline char* GetParsedHeaderField(int iParsedHeaderIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 32, iParsedHeaderIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetParsedHeaderValue(int iParsedHeaderIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 33, iParsedHeaderIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetPassword() {
      void* val = IPWorks_REST_Get(m_pObj, 34, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetPassword(const char* lpszPassword) {
      return IPWorks_REST_Set(m_pObj, 34, 0, (void*)lpszPassword, 0);
    }

    inline int GetPostData(char* &lpPostData, int &lenPostData) {
      lpPostData = (char*)IPWorks_REST_Get(m_pObj, 35, 0, &lenPostData, NULL);
    ...
    inline int GetProxyAuthScheme() {
      void* val = IPWorks_REST_Get(m_pObj, 36, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline int GetProxyAutoDetect() {
      void* val = IPWorks_REST_Get(m_pObj, 37, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline char* GetProxyPassword() {
      void* val = IPWorks_REST_Get(m_pObj, 38, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetProxyPassword(const char* lpszProxyPassword) {
      return IPWorks_REST_Set(m_pObj, 38, 0, (void*)lpszProxyPassword, 0);
    }

    inline int GetProxyPort() {
      void* val = IPWorks_REST_Get(m_pObj, 39, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline char* GetProxyServer() {
      void* val = IPWorks_REST_Get(m_pObj, 40, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetProxyServer(const char* lpszProxyServer) {
      return IPWorks_REST_Set(m_pObj, 40, 0, (void*)lpszProxyServer, 0);
    }

    inline int GetProxySSL() {
      void* val = IPWorks_REST_Get(m_pObj, 41, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline char* GetProxyUser() {
      void* val = IPWorks_REST_Get(m_pObj, 42, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetProxyUser(const char* lpszProxyUser) {
      return IPWorks_REST_Set(m_pObj, 42, 0, (void*)lpszProxyUser, 0);
    }

    inline char* GetReferer() {
      void* val = IPWorks_REST_Get(m_pObj, 43, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetReferer(const char* lpszReferer) {
      return IPWorks_REST_Set(m_pObj, 43, 0, (void*)lpszReferer, 0);
    }

    inline int GetSSLAcceptServerCertEncoded(char* &lpSSLAcceptServerCertEncoded, int &lenSSLAcceptServerCertEncoded) {
      lpSSLAcceptServerCertEncoded = (char*)IPWorks_REST_Get(m_pObj, 44, 0, &lenSSLAcceptServerCertEncoded, NULL);
    ...
    inline int GetSSLCertEncoded(char* &lpSSLCertEncoded, int &lenSSLCertEncoded) {
      lpSSLCertEncoded = (char*)IPWorks_REST_Get(m_pObj, 45, 0, &lenSSLCertEncoded, NULL);
    ...
    inline int GetSSLCertStore(char* &lpSSLCertStore, int &lenSSLCertStore) {
      lpSSLCertStore = (char*)IPWorks_REST_Get(m_pObj, 46, 0, &lenSSLCertStore, NULL);
    ...
    inline char* GetSSLCertStorePassword() {
      void* val = IPWorks_REST_Get(m_pObj, 47, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetSSLCertStorePassword(const char* lpszSSLCertStorePassword) {
      return IPWorks_REST_Set(m_pObj, 47, 0, (void*)lpszSSLCertStorePassword, 0);
    }

    inline int GetSSLCertStoreType() {
      void* val = IPWorks_REST_Get(m_pObj, 48, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline char* GetSSLCertSubject() {
      void* val = IPWorks_REST_Get(m_pObj, 49, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetSSLCertSubject(const char* lpszSSLCertSubject) {
      return IPWorks_REST_Set(m_pObj, 49, 0, (void*)lpszSSLCertSubject, 0);
    }

    inline int GetSSLServerCertEncoded(char* &lpSSLServerCertEncoded, int &lenSSLServerCertEncoded) {
      lpSSLServerCertEncoded = (char*)IPWorks_REST_Get(m_pObj, 50, 0, &lenSSLServerCertEncoded, NULL);
      return lpSSLServerCertEncoded ? 0 : lenSSLServerCertEncoded;
    }

    inline char* GetStatusLine() {
      void* val = IPWorks_REST_Get(m_pObj, 51, 0, NULL, NULL);
      return (char*)val;
    }

    inline int GetTimeout() {
      void* val = IPWorks_REST_Get(m_pObj, 52, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline int GetTransferredData(char* &lpTransferredData, int &lenTransferredData) {
      lpTransferredData = (char*)IPWorks_REST_Get(m_pObj, 53, 0, &lenTransferredData, NULL);
    ...
    inline char* GetTransferredHeaders() {
      void* val = IPWorks_REST_Get(m_pObj, 55, 0, NULL, NULL);
      return (char*)val;
    }

    inline char* GetURL() {
      void* val = IPWorks_REST_Get(m_pObj, 56, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetURL(const char* lpszURL) {
      return IPWorks_REST_Set(m_pObj, 56, 0, (void*)lpszURL, 0);
    }

    inline char* GetUser() {
      void* val = IPWorks_REST_Get(m_pObj, 57, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetUser(const char* lpszUser) {
      return IPWorks_REST_Set(m_pObj, 57, 0, (void*)lpszUser, 0);
    }

    inline int GetValidate() {
      void* val = IPWorks_REST_Get(m_pObj, 58, 0, NULL, NULL);
      return (int)(long)val;
    }
    ...
    inline int GetAttrCount() {
      void* val = IPWorks_REST_Get(m_pObj, 59, 0, NULL, NULL);
      return (int)(long)val;
    }

    inline char* GetAttrName(int iAttrIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 60, iAttrIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetAttrNamespace(int iAttrIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 61, iAttrIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetAttrPrefix(int iAttrIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 62, iAttrIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetAttrValue(int iAttrIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 63, iAttrIndex, NULL, NULL);
      return (char*)val;
    }

    inline int GetXChildCount() {
      void* val = IPWorks_REST_Get(m_pObj, 64, 0, NULL, NULL);
      return (int)(long)val;
    }

    inline char* GetXChildName(int iXChildIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 65, iXChildIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetXChildNamespace(int iXChildIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 66, iXChildIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetXChildPrefix(int iXChildIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 67, iXChildIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetXChildXText(int iXChildIndex) {
      void* val = IPWorks_REST_Get(m_pObj, 68, iXChildIndex, NULL, NULL);
      return (char*)val;
    }

    inline char* GetXElement() {
      void* val = IPWorks_REST_Get(m_pObj, 69, 0, NULL, NULL);
      return (char*)val;
    }

    inline char* GetXErrorPath() {
      void* val = IPWorks_REST_Get(m_pObj, 70, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetXErrorPath(const char* lpszXErrorPath) {
      return IPWorks_REST_Set(m_pObj, 70, 0, (void*)lpszXErrorPath, 0);
    }

    inline char* GetXNamespace() {
      void* val = IPWorks_REST_Get(m_pObj, 71, 0, NULL, NULL);
      return (char*)val;
    }

    inline char* GetXParent() {
      void* val = IPWorks_REST_Get(m_pObj, 72, 0, NULL, NULL);
      return (char*)val;
    }

    inline char* GetXPath() {
      void* val = IPWorks_REST_Get(m_pObj, 73, 0, NULL, NULL);
      return (char*)val;
    }
    inline int SetXPath(const char* lpszXPath) {
      return IPWorks_REST_Set(m_pObj, 73, 0, (void*)lpszXPath, 0);
    }

    inline char* GetXPrefix() {
      void* val = IPWorks_REST_Get(m_pObj, 74, 0, NULL, NULL);
      return (char*)val;
    }

    inline char* GetXSubTree() {
      void* val = IPWorks_REST_Get(m_pObj, 75, 0, NULL, NULL);
      return (char*)val;
    }

    inline char* GetXText() {
      void* val = IPWorks_REST_Get(m_pObj, 76, 0, NULL, NULL);
      return (char*)val;
    }
  ...
  public: // Methods
    inline int AddCookie(const char* lpszCookieName, const char* lpszCookieValue) {
      ...
      return IPWorks_REST_Do(m_pObj, 2, 2, param, cbparam, NULL);
    }

    inline char* Attr(const char* lpszAttrName) {
      void *param[1+1] = {(void*)IPW64CAST(lpszAttrName), 0};
      int cbparam[1+1] = {0, 0};
      IPWorks_REST_Do(m_pObj, 3, 1, param, cbparam, NULL);
    ...
    inline char* Config(const char* lpszConfigurationString) {
      ...
      int cbparam[1+1] = {0, 0};
      IPWorks_REST_Do(m_pObj, 4, 1, param, cbparam, NULL);
      return (char*)IPW64CAST(param[1]);
    }
    ...
    inline int Delete(const char* lpszURL) {
      ...
      int cbparam[1+1] = {0, 0};
      return IPWorks_REST_Do(m_pObj, 5, 1, param, cbparam, NULL);
    }

    inline int DoEvents() {
      void *param[0+1] = {0};
      int cbparam[0+1] = {0};
      return IPWorks_REST_Do(m_pObj, 6, 0, param, cbparam, NULL);
    }

    inline int Get(const char* lpszURL) {
      void *param[1+1] = {(void*)IPW64CAST(lpszURL), 0};
      int cbparam[1+1] = {0, 0};
      return IPWorks_REST_Do(m_pObj, 7, 1, param, cbparam, NULL);
    }

    inline int HasXPath(const char* lpszXPath) {
      void *param[1+1] = {(void*)IPW64CAST(lpszXPath), 0};
      int cbparam[1+1] = {0, 0};
      IPWorks_REST_Do(m_pObj, 8, 1, param, cbparam, NULL);
    ...
    inline int Interrupt() {
      void *param[0+1] = {0};
      int cbparam[0+1] = {0};
      return IPWorks_REST_Do(m_pObj, 9, 0, param, cbparam, NULL);
    }

    inline int Post(const char* lpszURL) {
      void *param[1+1] = {(void*)IPW64CAST(lpszURL), 0};
      int cbparam[1+1] = {0, 0};
      return IPWorks_REST_Do(m_pObj, 10, 1, param, cbparam, NULL);
    }

    inline int Put(const char* lpszURL) {
      void *param[1+1] = {(void*)IPW64CAST(lpszURL), 0};
      int cbparam[1+1] = {0, 0};
      return IPWorks_REST_Do(m_pObj, 11, 1, param, cbparam, NULL);
    }

    inline int Reset() {
      void *param[0+1] = {0};
      int cbparam[0+1] = {0};
      return IPWorks_REST_Do(m_pObj, 12, 0, param, cbparam, NULL);
    }

    inline int TryXPath(const char* lpszxpath) {
      void *param[1+1] = {(void*)IPW64CAST(lpszxpath), 0};
      int cbparam[1+1] = {0, 0};
      IPWorks_REST_Do(m_pObj, 13, 1, param, cbparam, NULL);
      return (int)IPW64CAST(param[1]);
    }
