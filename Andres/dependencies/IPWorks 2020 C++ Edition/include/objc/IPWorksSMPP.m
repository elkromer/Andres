...
#if __cplusplus
#define SMPP_EXTERN extern "C"
#else
#define SMPP_EXTERN extern
#endif

SMPP_EXTERN void* IPWorks_EvtStr(void* lpEvtStr, int esid, void* val, int opt);
SMPP_EXTERN void* IPWorks_SMPP_Create(void* lpSink, void* lpContext, char* lpOemKey, int opts);
SMPP_EXTERN int   IPWorks_SMPP_Destroy(void* lpObj);
SMPP_EXTERN int   IPWorks_SMPP_CheckIndex(void* lpObj, int propid, int arridx);
SMPP_EXTERN void* IPWorks_SMPP_Get(void* lpObj, int propid, int arridx, int* lpcbVal, long long* lpllVal);
SMPP_EXTERN int   IPWorks_SMPP_Set(void* lpObj, int propid, int arridx, void* val, int cbVal);
SMPP_EXTERN int   IPWorks_SMPP_Do(void* lpObj, int methid, int cparam, void* param[], int cbparam[], long long* lpllVal);
SMPP_EXTERN char* IPWorks_SMPP_GetLastError(void* lpObj);
SMPP_EXTERN int   IPWorks_SMPP_GetLastErrorCode(void* lpObj);
SMPP_EXTERN int   IPWorks_SMPP_SetLastErrorAndCode(void* lpObj, int code, char* message);
SMPP_EXTERN char* IPWorks_SMPP_GetEventError(void* lpObj);
SMPP_EXTERN int   IPWorks_SMPP_GetEventErrorCode(void* lpObj);
SMPP_EXTERN int   IPWorks_SMPP_SetEventErrorAndCode(void* lpObj, int code, char* message);

static void SMPP_cCallBack(CFSocketRef s, CFSocketCallBackType ct, CFDataRef addr, const void *data, void *info) {
  void* param[1] = {(void*)(long)CFSocketGetNative(s)};
  IPWorks_SMPP_Do(info, 2002/*MID_DOSOCKETEVENTS*/, 1, param, 0, nil);
}
...
static int SMPP_cSink(id lpObj, int event_id, int cparam, void* param[], int cbparam[]) {
  IPWorksSMPP* ctl = (IPWorksSMPP*)lpObj;
  ...
  switch (event_id) {
    ...
    case 2001 /*EID_ASYNCSELECT*/: {
      ...
      if (!param[2]) {
        void* notifier = (void*)CFSocketCreateWithNative(NULL, (CFSocketNativeHandle)((unsigned long)param[0]), evtflags, SMPP_cCallBack, &ctx);
    ...
    case 2003 /*EID_SHOWTRAILLICMSGFORIOS*/: {
      ...
      UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"IPWorks 2020 (SMPP)" message:msg delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
      [myAlert show];
      return 1;
    ...
    case 5 /*EID_MESSAGEIN*/: {
      NSString* sourceAddressT = [NSString stringWithCString:(const char*)param[0] encoding:[ctl innerGetCodePage]];
      NSString* sourceAddress = sourceAddressT;
      NSString* scheduleDeliveryTimeT = [NSString stringWithCString:(const char*)param[1] encoding:[ctl innerGetCodePage]];
      NSString* scheduleDeliveryTime = scheduleDeliveryTimeT;
      NSString* validityPeriodT = [NSString stringWithCString:(const char*)param[2] encoding:[ctl innerGetCodePage]];
      NSString* validityPeriod = validityPeriodT;
      NSString* messageT = [NSString stringWithCString:(const char*)param[3] encoding:[ctl innerGetCodePage]];
      NSString* message = messageT;
      int messagePart = (int)(long)param[4];
      int messagePartCount = (int)(long)param[5];
      int messagePartReference = (int)(long)param[6];
      NSString* destinationAddressT = [NSString stringWithCString:(const char*)param[7] encoding:[ctl innerGetCodePage]];
      NSString* destinationAddress = destinationAddressT;
      int* responseErrorCode = (int*)&param[8];
      @try {
        [ctl onMessageIn :sourceAddress :scheduleDeliveryTime :validityPeriod :message :messagePart :messagePartCount :messagePartReference :destinationAddress :responseErrorCode];
      }
      @catch (NSException* e) {
    ...
    case 6 /*EID_MESSAGESTATUS*/: {
      ...
      int messageState = (int)(long)param[1];
      int messageError = (int)(long)param[2];
      NSString* finalDateT = [NSString stringWithCString:(const char*)param[3] encoding:[ctl innerGetCodePage]];
      NSString* finalDate = finalDateT;
      @try {
        [ctl onMessageStatus :messageId :messageState :messageError :finalDate];
      }
      @catch (NSException* e) {
        [ctl reportEventException:e :@"MessageStatus" :YES];
      }
      break;
    }
    case 7 /*EID_PITRAIL*/: {
      int direction = (int)(long)param[0];
      NSData* PDU = [NSData dataWithBytesNoCopy:param[1] length:cbparam[1] freeWhenDone:NO];
      int commandLength = (int)(long)param[2];
      int commandId = (int)(long)param[3];
      NSString* commandDescriptionT = [NSString stringWithCString:(const char*)param[4] encoding:[ctl innerGetCodePage]];
      NSString* commandDescription = commandDescriptionT;
      NSString* commandStatusT = [NSString stringWithCString:(const char*)param[5] encoding:[ctl innerGetCodePage]];
      NSString* commandStatus = commandStatusT;
      int sequenceNumber = (int)(long)param[6];
      @try {
        [ctl onPITrail :direction :PDU :commandLength :commandId :commandDescription :commandStatus :sequenceNumber];
      }
      @catch (NSException* e) {
...
@implementation IPWorksSMPP

+ (IPWorksSMPP*)smpp
{
#if __has_feature(objc_arc)
  return [[IPWorksSMPP alloc] init];
#else
  return [[[IPWorksSMPP alloc] init] autorelease];
#endif
}
...
#if __has_feature(objc_arc)
  m_pObj = IPWorks_SMPP_Create((void*)SMPP_cSink, (__bridge void*)self, (char *)"\1\1\1MAC\1\1\1", 0);
#else
  m_pObj = IPWorks_SMPP_Create((void*)SMPP_cSink, self, (char *)"\1\1\1MAC\1\1\1", 0);
#endif
  if (m_pObj) IPWorks_SMPP_Do(m_pObj, 2001/*MID_ENABLEASYNCEVENTS*/, 0, 0, 0, nil);
...
- (NSString*)lastError
{
  return [NSString stringWithCString:(const char*)IPWorks_SMPP_GetLastError(m_pObj) encoding:[self innerGetCodePage]];
}
...
- (int)eventErrorCode
{
  return IPWorks_SMPP_GetEventErrorCode(m_pObj);
}
...
- (void) setDelegate:(id <IPWorksSMPPDelegate>)anObject
{
  ...
  if (m_delegate != nil) {
    ...
    if ([m_delegate respondsToSelector:@selector(onMessageStatus::::)]) m_delegateHasMessageStatus = YES;
...
- (void)onMessageIn:(NSString*)sourceAddress :(NSString*)scheduleDeliveryTime :(NSString*)validityPeriod :(NSString*)message :(int)messagePart :(int)messagePartCount :(int)messagePartReference :(NSString*)destinationAddress :(int*)responseErrorCode
{
  if (m_delegate != nil && m_delegateHasMessageIn)
    [m_delegate onMessageIn:sourceAddress :scheduleDeliveryTime :validityPeriod :message :messagePart :messagePartCount :messagePartReference :destinationAddress :responseErrorCode];
}
- (void)onMessageStatus:(NSString*)messageId :(int)messageState :(int)messageError :(NSString*)finalDate
{
  if (m_delegate != nil && m_delegateHasMessageStatus)
...
{
  int len = 0;
  void* val = IPWorks_SMPP_Get(m_pObj, 2011, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj)) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)setRuntimeLicense:(NSString*)newRuntimeLicense
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 2011, 0, val, len);
  if (ret_code) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)VERSION
{
  void* val = IPWorks_SMPP_Get(m_pObj, 0, 0, 0, nil);
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 1, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 2, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setFirewallAutoDetect:(BOOL)newFirewallAutoDetect
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 2, 0, val, 0);
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 3, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFirewallType:(int)newFirewallType
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 3, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 4, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallHost:(NSString*)newFirewallHost
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 4, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 5, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallPassword:(NSString*)newFirewallPassword
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 5, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 6, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFirewallPort:(int)newFirewallPort
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 6, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 7, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallUser:(NSString*)newFirewallUser
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 7, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 8, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 9, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setLocalHost:(NSString*)newLocalHost
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 9, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 10, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newMessageExpiration];
  int ret_code = IPWorks_SMPP_Set(m_pObj, 10, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 11, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 12, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  void *val = (void*)(long)newMessagePriority;
  int ret_code = IPWorks_SMPP_Set(m_pObj, 12, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 13, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setPassword:(NSString*)newPassword
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 13, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 14, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setProtocol:(int)newProtocol
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 14, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 15, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  void *val = (void*)(long)newRecipientCount;
  int ret_code = IPWorks_SMPP_Set(m_pObj, 15, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 16, recipientIndex, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newRecipientAddress];
  int ret_code = IPWorks_SMPP_Set(m_pObj, 16, recipientIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 17, recipientIndex, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  void *val = (void*)(long)newRecipientType;
  int ret_code = IPWorks_SMPP_Set(m_pObj, 17, recipientIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 18, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newScheduledDelivery];
  int ret_code = IPWorks_SMPP_Set(m_pObj, 18, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 19, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newSenderAddress];
  int ret_code = IPWorks_SMPP_Set(m_pObj, 19, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 20, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  void *val = (void*)(long)newServiceType;
  int ret_code = IPWorks_SMPP_Set(m_pObj, 20, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 21, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  void *val = (void*)(long)newSMPPPort;
  int ret_code = IPWorks_SMPP_Set(m_pObj, 21, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 22, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newSMPPServer];
  int ret_code = IPWorks_SMPP_Set(m_pObj, 22, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 23, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  void *val = (void*)(long)newSMPPVersion;
  int ret_code = IPWorks_SMPP_Set(m_pObj, 23, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 24, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)setSSLAcceptServerCertEncoded:(NSString*)newSSLAcceptServerCertEncoded
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 24, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 25, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertEncoded:(NSString*)newSSLCertEncoded
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 25, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 26, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertStore:(NSString*)newSSLCertStore
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 26, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 27, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertStorePassword:(NSString*)newSSLCertStorePassword
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 27, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 28, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setSSLCertStoreType:(int)newSSLCertStoreType
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 28, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 29, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertSubject:(NSString*)newSSLCertSubject
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 29, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 30, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setSSLEnabled:(BOOL)newSSLEnabled
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 30, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 31, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 32, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setSSLStartMode:(int)newSSLStartMode
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 32, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 33, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newSystemType];
  int ret_code = IPWorks_SMPP_Set(m_pObj, 33, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 34, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setTimeout:(int)newTimeout
{
  ...
  int ret_code = IPWorks_SMPP_Set(m_pObj, 34, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_SMPP_Get(m_pObj, 35, 0, &len, nil);
  if (IPWorks_SMPP_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newUserId];
  int ret_code = IPWorks_SMPP_Set(m_pObj, 35, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  void *param[2+1] = {(void*)(long)recipientType, (void*)[self nsstringToCString:recipientAddress], NULL};
  int cbparam[2+1] = {0, 0, 0};

  int ret_code = IPWorks_SMPP_Do(m_pObj, 2, 2, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (void)cancelMessage:(NSString*)messageId
{
  void *param[1+1] = {(void*)[self nsstringToCString:messageId], NULL};
  int cbparam[1+1] = {0, 0};

  int ret_code = IPWorks_SMPP_Do(m_pObj, 3, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)checkLink
{
  ...
  int ret_code = IPWorks_SMPP_Do(m_pObj, 4, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)checkMessageStatus:(NSString*)messageId
{
  ...
  int ret_code = IPWorks_SMPP_Do(m_pObj, 5, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (NSString*)config:(NSString*)configurationString
{
  ...
  int ret_code = IPWorks_SMPP_Do(m_pObj, 6, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)param[1] encoding:[self innerGetCodePage]];
}

- (void)connect:(NSString*)userId :(NSString*)password
{
  void *param[2+1] = {(void*)[self nsstringToCString:userId], (void*)[self nsstringToCString:password], NULL};
  int cbparam[2+1] = {0, 0, 0};

  int ret_code = IPWorks_SMPP_Do(m_pObj, 7, 2, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)disconnect
{
  ...
  int ret_code = IPWorks_SMPP_Do(m_pObj, 8, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)doEvents
{
  ...
  int ret_code = IPWorks_SMPP_Do(m_pObj, 9, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)interrupt
{
  ...
  int ret_code = IPWorks_SMPP_Do(m_pObj, 10, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (void)replaceMessage:(NSString*)messageId :(NSString*)newMessage
{
  void *param[2+1] = {(void*)[self nsstringToCString:messageId], (void*)[self nsstringToCString:newMessage], NULL};
  int cbparam[2+1] = {0, 0, 0};

  int ret_code = IPWorks_SMPP_Do(m_pObj, 11, 2, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)reset
{
  ...
  int ret_code = IPWorks_SMPP_Do(m_pObj, 12, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSData*)sendCommand:(int)commandId :(NSData*)payload
{
  void *param[2+1] = {(void*)(long)commandId, (void*)[payload bytes], NULL};
  int cbparam[2+1] = {0, (int)[payload length], 0};

  int ret_code = IPWorks_SMPP_Do(m_pObj, 13, 2, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSData dataWithBytesNoCopy:param[2] length:cbparam[2] freeWhenDone:NO];
}

- (NSString*)sendData:(NSData*)data
{
  void *param[1+1] = {(void*)[data bytes], NULL};
  int cbparam[1+1] = {(int)[data length], 0};

  int ret_code = IPWorks_SMPP_Do(m_pObj, 14, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)param[1] encoding:[self innerGetCodePage]];
}
...
{
  void *param[1+1] = {(void*)[self nsstringToCString:message], NULL};
  int cbparam[1+1] = {0, 0};

  int ret_code = IPWorks_SMPP_Do(m_pObj, 15, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)param[1] encoding:[self innerGetCodePage]];
}
...
- (NSStringEncoding)innerGetCodePage {
  int len = 0;
  int codePage = (int)(long)IPWorks_SMPP_Get(m_pObj, 2010, 0, &len, nil);
...
- (void)reportEventException:(NSException*)ex :(NSString*)event :(BOOL)reFire {
  ...
  IPWorks_SMPP_SetEventErrorAndCode(m_pObj, -1, [self nsstringToCString:msg]);
