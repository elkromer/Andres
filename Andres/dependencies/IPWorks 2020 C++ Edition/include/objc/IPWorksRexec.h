...
@protocol IPWorksRexecDelegate <NSObject>
@optional
...
@interface IPWorksRexec : NSObject {
  @public void* m_pObj;
  @public CFMutableArrayRef m_rNotifiers;
  __unsafe_unretained id <IPWorksRexecDelegate> m_delegate;
...
@property (nonatomic,readwrite,assign,getter=delegate,setter=setDelegate:) id <IPWorksRexecDelegate> delegate;
...
@property (nonatomic,readwrite,assign,getter=remotePassword,setter=setRemotePassword:) NSString* remotePassword NS_SWIFT_NAME(remotePassword);
- (NSString*)remotePassword NS_SWIFT_NAME(remotePassword());
- (void)setRemotePassword:(NSString*)newRemotePassword NS_SWIFT_NAME(setRemotePassword(_:));
