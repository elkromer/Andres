...
#if __cplusplus
#define WebUpload_EXTERN extern "C"
#else
#define WebUpload_EXTERN extern
#endif

WebUpload_EXTERN void* IPWorks_EvtStr(void* lpEvtStr, int esid, void* val, int opt);
WebUpload_EXTERN void* IPWorks_WebUpload_Create(void* lpSink, void* lpContext, char* lpOemKey, int opts);
WebUpload_EXTERN int   IPWorks_WebUpload_Destroy(void* lpObj);
WebUpload_EXTERN int   IPWorks_WebUpload_CheckIndex(void* lpObj, int propid, int arridx);
WebUpload_EXTERN void* IPWorks_WebUpload_Get(void* lpObj, int propid, int arridx, int* lpcbVal, long long* lpllVal);
WebUpload_EXTERN int   IPWorks_WebUpload_Set(void* lpObj, int propid, int arridx, void* val, int cbVal);
WebUpload_EXTERN int   IPWorks_WebUpload_Do(void* lpObj, int methid, int cparam, void* param[], int cbparam[], long long* lpllVal);
WebUpload_EXTERN char* IPWorks_WebUpload_GetLastError(void* lpObj);
WebUpload_EXTERN int   IPWorks_WebUpload_GetLastErrorCode(void* lpObj);
WebUpload_EXTERN int   IPWorks_WebUpload_SetLastErrorAndCode(void* lpObj, int code, char* message);
WebUpload_EXTERN char* IPWorks_WebUpload_GetEventError(void* lpObj);
WebUpload_EXTERN int   IPWorks_WebUpload_GetEventErrorCode(void* lpObj);
WebUpload_EXTERN int   IPWorks_WebUpload_SetEventErrorAndCode(void* lpObj, int code, char* message);

static void WebUpload_cCallBack(CFSocketRef s, CFSocketCallBackType ct, CFDataRef addr, const void *data, void *info) {
  void* param[1] = {(void*)(long)CFSocketGetNative(s)};
  IPWorks_WebUpload_Do(info, 2002/*MID_DOSOCKETEVENTS*/, 1, param, 0, nil);
}
...
static int WebUpload_cSink(id lpObj, int event_id, int cparam, void* param[], int cbparam[]) {
  IPWorksWebUpload* ctl = (IPWorksWebUpload*)lpObj;
  ...
  switch (event_id) {
    ...
    case 2001 /*EID_ASYNCSELECT*/: {
      ...
      if (!param[2]) {
        void* notifier = (void*)CFSocketCreateWithNative(NULL, (CFSocketNativeHandle)((unsigned long)param[0]), evtflags, WebUpload_cCallBack, &ctx);
    ...
    case 2003 /*EID_SHOWTRAILLICMSGFORIOS*/: {
      ...
      UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"IPWorks 2020 (WebUpload)" message:msg delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
      [myAlert show];
      return 1;
    ...
    case 15 /*EID_UPLOADPROGRESS*/: {
      int percentDone = (int)(long)param[0];
      @try {
        [ctl onUploadProgress :percentDone];
      }
      @catch (NSException* e) {
        [ctl reportEventException:e :@"UploadProgress" :YES];
      }
      break;
    }
...
@implementation IPWorksWebUpload

+ (IPWorksWebUpload*)webupload
{
#if __has_feature(objc_arc)
  return [[IPWorksWebUpload alloc] init];
#else
  return [[[IPWorksWebUpload alloc] init] autorelease];
#endif
}
...
#if __has_feature(objc_arc)
  m_pObj = IPWorks_WebUpload_Create((void*)WebUpload_cSink, (__bridge void*)self, (char *)"\1\1\1MAC\1\1\1", 0);
#else
  m_pObj = IPWorks_WebUpload_Create((void*)WebUpload_cSink, self, (char *)"\1\1\1MAC\1\1\1", 0);
#endif
  if (m_pObj) IPWorks_WebUpload_Do(m_pObj, 2001/*MID_ENABLEASYNCEVENTS*/, 0, 0, 0, nil);
...
- (NSString*)lastError
{
  return [NSString stringWithCString:(const char*)IPWorks_WebUpload_GetLastError(m_pObj) encoding:[self innerGetCodePage]];
}
...
- (int)eventErrorCode
{
  return IPWorks_WebUpload_GetEventErrorCode(m_pObj);
}

- (id <IPWorksWebUploadDelegate>)delegate
{
  return m_delegate;
}

- (void) setDelegate:(id <IPWorksWebUploadDelegate>)anObject
{
  ...
  m_delegateHasUploadProgress = NO;
  ...
  if (m_delegate != nil) {
    ...
    if ([m_delegate respondsToSelector:@selector(onUploadProgress:)]) m_delegateHasUploadProgress = YES;
  }
}
...
{
  if (m_delegate != nil && m_delegateHasUploadProgress)
...
{
  int len = 0;
  void* val = IPWorks_WebUpload_Get(m_pObj, 2011, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj)) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)setRuntimeLicense:(NSString*)newRuntimeLicense
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 2011, 0, val, len);
  if (ret_code) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)VERSION
{
  void* val = IPWorks_WebUpload_Get(m_pObj, 0, 0, 0, nil);
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 1, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setAccept:(NSString*)newAccept
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 1, 0, val, 0);
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 2, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setAuthorization:(NSString*)newAuthorization
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 2, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 3, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setAuthScheme:(int)newAuthScheme
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 3, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 4, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setConnected:(BOOL)newConnected
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 4, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 5, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setContentType:(NSString*)newContentType
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 5, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 6, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setCookieCount:(int)newCookieCount
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 6, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 7, cookieIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 8, cookieIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 9, cookieIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setCookieName:(int)cookieIndex:(NSString*)newCookieName
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 9, cookieIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 10, cookieIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 11, cookieIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 12, cookieIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setCookieValue:(int)cookieIndex:(NSString*)newCookieValue
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 12, cookieIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 13, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  void *val = (void*)(long)newFileCount;
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 13, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)fileVarContentType:(int)fileIndex
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 14, fileIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}

- (void)setFileVarContentType:(int)fileIndex:(NSString*)newFileVarContentType
{
  void *val = (void*)[self nsstringToCString:newFileVarContentType];
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 14, fileIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 15, fileIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newFileVarFile];
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 15, fileIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = (int)[newFileVarInputData lengthOfBytesUsingEncoding:[self innerGetCodePage]];
  void *val = (void*)[self nsstringToCString:newFileVarInputData];
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 16, fileIndex, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

// Placeholder for writeonly properties.
- (NSData*)fileVarInputDataB:(int)fileIndex
{
  return nil;
}

- (void)setFileVarInputDataB:(int)fileIndex :(NSData*)newFileVarInputData
{
  int len = (int)[newFileVarInputData length];
  void *val = (void*)[newFileVarInputData bytes];
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 16, fileIndex, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)fileVarName:(int)fileIndex
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 17, fileIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}

- (void)setFileVarName:(int)fileIndex:(NSString*)newFileVarName
{
  void *val = (void*)[self nsstringToCString:newFileVarName];
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 17, fileIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 18, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setFirewallAutoDetect:(BOOL)newFirewallAutoDetect
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 18, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 19, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFirewallType:(int)newFirewallType
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 19, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 20, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallHost:(NSString*)newFirewallHost
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 20, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 21, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallPassword:(NSString*)newFirewallPassword
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 21, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 22, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFirewallPort:(int)newFirewallPort
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 22, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 23, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallUser:(NSString*)newFirewallUser
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 23, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 24, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFollowRedirects:(int)newFollowRedirects
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 24, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 25, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}

- (void)setFormVarCount:(int)newFormVarCount
{
  void *val = (void*)(long)newFormVarCount;
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 25, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)formVarContentType:(int)varIndex
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 26, varIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}

- (void)setFormVarContentType:(int)varIndex:(NSString*)newFormVarContentType
{
  void *val = (void*)[self nsstringToCString:newFormVarContentType];
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 26, varIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)formVarName:(int)varIndex
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 27, varIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}

- (void)setFormVarName:(int)varIndex:(NSString*)newFormVarName
{
  void *val = (void*)[self nsstringToCString:newFormVarName];
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 27, varIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 28, varIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newFormVarValue];
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 28, varIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 29, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFrom:(NSString*)newFrom
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 29, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 30, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 31, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setLocalFile:(NSString*)newLocalFile
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 31, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 32, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setLocalHost:(NSString*)newLocalHost
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 32, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 33, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setOtherHeaders:(NSString*)newOtherHeaders
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 33, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 34, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 35, parsedHeaderIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 36, parsedHeaderIndex, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 37, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setPassword:(NSString*)newPassword
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 37, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 38, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setProxyAuthScheme:(int)newProxyAuthScheme
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 38, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 39, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setProxyAutoDetect:(BOOL)newProxyAutoDetect
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 39, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 40, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setProxyPassword:(NSString*)newProxyPassword
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 40, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 41, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setProxyPort:(int)newProxyPort
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 41, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 42, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setProxyServer:(NSString*)newProxyServer
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 42, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 43, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setProxySSL:(int)newProxySSL
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 43, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 44, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setProxyUser:(NSString*)newProxyUser
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 44, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 45, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setReferer:(NSString*)newReferer
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 45, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 46, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)setSSLAcceptServerCertEncoded:(NSString*)newSSLAcceptServerCertEncoded
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 46, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 47, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertEncoded:(NSString*)newSSLCertEncoded
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 47, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 48, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertStore:(NSString*)newSSLCertStore
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 48, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 49, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertStorePassword:(NSString*)newSSLCertStorePassword
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 49, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 50, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setSSLCertStoreType:(int)newSSLCertStoreType
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 50, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 51, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertSubject:(NSString*)newSSLCertSubject
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 51, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 52, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 53, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 54, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setTimeout:(int)newTimeout
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 54, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 55, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (long long)transferredDataLimit
{
  int len = 0;
  long long llVal;
  IPWorks_WebUpload_Get(m_pObj, 56, 0, &len, &llVal);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return llVal;
}
...
- (void)setTransferredDataLimit:(long long)newTransferredDataLimit
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 56, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 57, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 58, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setURL:(NSString*)newURL
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 58, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebUpload_Get(m_pObj, 59, 0, &len, nil);
  if (IPWorks_WebUpload_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setUser:(NSString*)newUser
{
  ...
  int ret_code = IPWorks_WebUpload_Set(m_pObj, 59, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)addCookie:(NSString*)cookieName :(NSString*)cookieValue
{
  ...
  int ret_code = IPWorks_WebUpload_Do(m_pObj, 2, 2, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (void)addFileVar:(NSString*)fileVar :(NSString*)fileName
{
  void *param[2+1] = {(void*)[self nsstringToCString:fileVar], (void*)[self nsstringToCString:fileName], NULL};
  int cbparam[2+1] = {0, 0, 0};

  int ret_code = IPWorks_WebUpload_Do(m_pObj, 3, 2, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)addFormVar:(NSString*)varName :(NSString*)varValue
{
  ...
  int ret_code = IPWorks_WebUpload_Do(m_pObj, 4, 2, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (NSString*)config:(NSString*)configurationString
{
  ...
  int ret_code = IPWorks_WebUpload_Do(m_pObj, 5, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)doEvents
{
  ...
  int ret_code = IPWorks_WebUpload_Do(m_pObj, 6, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)interrupt
{
  ...
  int ret_code = IPWorks_WebUpload_Do(m_pObj, 7, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)reset
{
  ...
  int ret_code = IPWorks_WebUpload_Do(m_pObj, 8, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)upload
{
  ...
  int ret_code = IPWorks_WebUpload_Do(m_pObj, 9, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (void)uploadTo:(NSString*)URL
{
  void *param[1+1] = {(void*)[self nsstringToCString:URL], NULL};
  int cbparam[1+1] = {0, 0};

  int ret_code = IPWorks_WebUpload_Do(m_pObj, 10, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (NSStringEncoding)innerGetCodePage {
  int len = 0;
  int codePage = (int)(long)IPWorks_WebUpload_Get(m_pObj, 2010, 0, &len, nil);
...
- (void)reportEventException:(NSException*)ex :(NSString*)event :(BOOL)reFire {
  ...
  IPWorks_WebUpload_SetEventErrorAndCode(m_pObj, -1, [self nsstringToCString:msg]);
