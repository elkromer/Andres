...
@protocol IPWorksWebUploadDelegate <NSObject>
@optional
...
- (void)onUploadProgress:(int)percentDone NS_SWIFT_NAME(onUploadProgress(_:));
@end

@interface IPWorksWebUpload : NSObject {
  @public void* m_pObj;
  @public CFMutableArrayRef m_rNotifiers;
  __unsafe_unretained id <IPWorksWebUploadDelegate> m_delegate;
  ...
  BOOL m_delegateHasUploadProgress;
}
...
@property (nonatomic,readwrite,assign,getter=delegate,setter=setDelegate:) id <IPWorksWebUploadDelegate> delegate;
...
- (NSString*)fileVarContentType:(int)fileIndex NS_SWIFT_NAME(fileVarContentType(_:));
- (void)setFileVarContentType:(int)fileIndex:(NSString*)newFileVarContentType NS_SWIFT_NAME(setFileVarContentType(_:_:));

- (NSString*)fileVarFile:(int)fileIndex NS_SWIFT_NAME(fileVarFile(_:));
- (void)setFileVarFile:(int)fileIndex:(NSString*)newFileVarFile NS_SWIFT_NAME(setFileVarFile(_:_:));

- (NSString*)fileVarInputData:(int)fileIndex NS_SWIFT_NAME(fileVarInputData(_:));
- (void)setFileVarInputData:(int)fileIndex:(NSString*)newFileVarInputData NS_SWIFT_NAME(setFileVarInputData(_:_:));

- (NSData*)fileVarInputDataB:(int)fileIndex NS_SWIFT_NAME(fileVarInputDataB(_:));
- (void)setFileVarInputDataB:(int)fileIndex :(NSData*)newFileVarInputData NS_SWIFT_NAME(setFileVarInputDataB(_:_:));

- (NSString*)fileVarName:(int)fileIndex NS_SWIFT_NAME(fileVarName(_:));
- (void)setFileVarName:(int)fileIndex:(NSString*)newFileVarName NS_SWIFT_NAME(setFileVarName(_:_:));
...
- (void)addFileVar:(NSString*)fileVar :(NSString*)fileName NS_SWIFT_NAME(addFileVar(_:_:));
...
- (void)uploadTo:(NSString*)URL NS_SWIFT_NAME(uploadTo(_:));
