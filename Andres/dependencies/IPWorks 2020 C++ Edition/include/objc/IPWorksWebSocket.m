...
#if __cplusplus
#define WebSocket_EXTERN extern "C"
#else
#define WebSocket_EXTERN extern
#endif

WebSocket_EXTERN void* IPWorks_EvtStr(void* lpEvtStr, int esid, void* val, int opt);
WebSocket_EXTERN void* IPWorks_WebSocket_Create(void* lpSink, void* lpContext, char* lpOemKey, int opts);
WebSocket_EXTERN int   IPWorks_WebSocket_Destroy(void* lpObj);
WebSocket_EXTERN int   IPWorks_WebSocket_CheckIndex(void* lpObj, int propid, int arridx);
WebSocket_EXTERN void* IPWorks_WebSocket_Get(void* lpObj, int propid, int arridx, int* lpcbVal, long long* lpllVal);
WebSocket_EXTERN int   IPWorks_WebSocket_Set(void* lpObj, int propid, int arridx, void* val, int cbVal);
WebSocket_EXTERN int   IPWorks_WebSocket_Do(void* lpObj, int methid, int cparam, void* param[], int cbparam[], long long* lpllVal);
WebSocket_EXTERN char* IPWorks_WebSocket_GetLastError(void* lpObj);
WebSocket_EXTERN int   IPWorks_WebSocket_GetLastErrorCode(void* lpObj);
WebSocket_EXTERN int   IPWorks_WebSocket_SetLastErrorAndCode(void* lpObj, int code, char* message);
WebSocket_EXTERN char* IPWorks_WebSocket_GetEventError(void* lpObj);
WebSocket_EXTERN int   IPWorks_WebSocket_GetEventErrorCode(void* lpObj);
WebSocket_EXTERN int   IPWorks_WebSocket_SetEventErrorAndCode(void* lpObj, int code, char* message);

static void WebSocket_cCallBack(CFSocketRef s, CFSocketCallBackType ct, CFDataRef addr, const void *data, void *info) {
  void* param[1] = {(void*)(long)CFSocketGetNative(s)};
  IPWorks_WebSocket_Do(info, 2002/*MID_DOSOCKETEVENTS*/, 1, param, 0, nil);
}
...
static int WebSocket_cSink(id lpObj, int event_id, int cparam, void* param[], int cbparam[]) {
  IPWorksWebSocket* ctl = (IPWorksWebSocket*)lpObj;
  ...
  switch (event_id) {
    ...
    case 2001 /*EID_ASYNCSELECT*/: {
      ...
      if (!param[2]) {
        void* notifier = (void*)CFSocketCreateWithNative(NULL, (CFSocketNativeHandle)((unsigned long)param[0]), evtflags, WebSocket_cCallBack, &ctx);
    ...
    case 2003 /*EID_SHOWTRAILLICMSGFORIOS*/: {
      ...
      UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"IPWorks 2020 (WebSocket)" message:msg delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
      [myAlert show];
      return 1;
    ...
    case 3 /*EID_DATAIN*/: {
      int dataFormat = (int)(long)param[0];
      NSData* text = [NSData dataWithBytesNoCopy:param[1] length:cbparam[1] freeWhenDone:NO];
      BOOL EOM = param[2] ? YES : NO;
      @try {
        [ctl onDataIn :dataFormat :text :EOM];
      }
      @catch (NSException* e) {
...
@implementation IPWorksWebSocket

+ (IPWorksWebSocket*)websocket
{
#if __has_feature(objc_arc)
  return [[IPWorksWebSocket alloc] init];
#else
  return [[[IPWorksWebSocket alloc] init] autorelease];
#endif
}
...
#if __has_feature(objc_arc)
  m_pObj = IPWorks_WebSocket_Create((void*)WebSocket_cSink, (__bridge void*)self, (char *)"\1\1\1MAC\1\1\1", 0);
#else
  m_pObj = IPWorks_WebSocket_Create((void*)WebSocket_cSink, self, (char *)"\1\1\1MAC\1\1\1", 0);
#endif
  if (m_pObj) IPWorks_WebSocket_Do(m_pObj, 2001/*MID_ENABLEASYNCEVENTS*/, 0, 0, 0, nil);
...
- (NSString*)lastError
{
  return [NSString stringWithCString:(const char*)IPWorks_WebSocket_GetLastError(m_pObj) encoding:[self innerGetCodePage]];
}
...
- (int)eventErrorCode
{
  return IPWorks_WebSocket_GetEventErrorCode(m_pObj);
}
...
{
  int len = 0;
  void* val = IPWorks_WebSocket_Get(m_pObj, 2011, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj)) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)setRuntimeLicense:(NSString*)newRuntimeLicense
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 2011, 0, val, len);
  if (ret_code) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)VERSION
{
  void* val = IPWorks_WebSocket_Get(m_pObj, 0, 0, 0, nil);
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 1, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setAcceptData:(BOOL)newAcceptData
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 1, 0, val, 0);
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 2, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setAuthorization:(NSString*)newAuthorization
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 2, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 3, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setAuthScheme:(int)newAuthScheme
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 3, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 4, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 5, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setConnected:(BOOL)newConnected
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 5, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 6, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setCookieCount:(int)newCookieCount
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 6, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 7, cookieIndex, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 8, cookieIndex, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 9, cookieIndex, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setCookieName:(int)cookieIndex:(NSString*)newCookieName
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 9, cookieIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 10, cookieIndex, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 11, cookieIndex, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 12, cookieIndex, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setCookieValue:(int)cookieIndex:(NSString*)newCookieValue
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 12, cookieIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 13, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  void *val = (void*)(long)newDataFormat;
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 13, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)setDataToSend:(NSString*)newDataToSend
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 14, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 15, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setFirewallAutoDetect:(BOOL)newFirewallAutoDetect
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 15, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 16, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFirewallType:(int)newFirewallType
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 16, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 17, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallHost:(NSString*)newFirewallHost
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 17, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 18, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallPassword:(NSString*)newFirewallPassword
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 18, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 19, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFirewallPort:(int)newFirewallPort
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 19, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 20, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallUser:(NSString*)newFirewallUser
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 20, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 21, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFollowRedirects:(int)newFollowRedirects
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 21, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 22, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setLocalHost:(NSString*)newLocalHost
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 22, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 23, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setLocalPort:(int)newLocalPort
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 23, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 24, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newOrigin];
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 24, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 25, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setOtherHeaders:(NSString*)newOtherHeaders
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 25, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 26, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 27, parsedHeaderIndex, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 28, parsedHeaderIndex, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 29, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setPassword:(NSString*)newPassword
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 29, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 30, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setProxyAuthScheme:(int)newProxyAuthScheme
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 30, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 31, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setProxyAutoDetect:(BOOL)newProxyAutoDetect
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 31, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 32, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setProxyPassword:(NSString*)newProxyPassword
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 32, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 33, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setProxyPort:(int)newProxyPort
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 33, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 34, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setProxyServer:(NSString*)newProxyServer
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 34, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 35, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setProxySSL:(int)newProxySSL
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 35, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 36, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setProxyUser:(NSString*)newProxyUser
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 36, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 37, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 38, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)setSSLAcceptServerCertEncoded:(NSString*)newSSLAcceptServerCertEncoded
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 38, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 39, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertEncoded:(NSString*)newSSLCertEncoded
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 39, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 40, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertStore:(NSString*)newSSLCertStore
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 40, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 41, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertStorePassword:(NSString*)newSSLCertStorePassword
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 41, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 42, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setSSLCertStoreType:(int)newSSLCertStoreType
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 42, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 43, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertSubject:(NSString*)newSSLCertSubject
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 43, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 44, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 45, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newSubProtocols];
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 45, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 46, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setTimeout:(int)newTimeout
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 46, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 47, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_WebSocket_Get(m_pObj, 48, 0, &len, nil);
  if (IPWorks_WebSocket_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setUser:(NSString*)newUser
{
  ...
  int ret_code = IPWorks_WebSocket_Set(m_pObj, 48, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)addCookie:(NSString*)cookieName :(NSString*)cookieValue
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 2, 2, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (NSString*)config:(NSString*)configurationString
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 3, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)connect:(NSString*)URL
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 4, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)disconnect
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 5, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)doEvents
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 6, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)interrupt
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 7, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)ping
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 8, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)reset
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 9, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)resetHeaders
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 10, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)send:(NSData*)data
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 11, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)sendFile:(NSString*)fileName
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 12, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)sendText:(NSString*)text
{
  ...
  int ret_code = IPWorks_WebSocket_Do(m_pObj, 13, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (NSStringEncoding)innerGetCodePage {
  int len = 0;
  int codePage = (int)(long)IPWorks_WebSocket_Get(m_pObj, 2010, 0, &len, nil);
...
- (void)reportEventException:(NSException*)ex :(NSString*)event :(BOOL)reFire {
  ...
  IPWorks_WebSocket_SetEventErrorAndCode(m_pObj, -1, [self nsstringToCString:msg]);
