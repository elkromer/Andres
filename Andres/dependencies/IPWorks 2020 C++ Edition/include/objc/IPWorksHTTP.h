...
@protocol IPWorksHTTPDelegate <NSObject>
@optional
...
@interface IPWorksHTTP : NSObject {
  @public void* m_pObj;
  @public CFMutableArrayRef m_rNotifiers;
  __unsafe_unretained id <IPWorksHTTPDelegate> m_delegate;
...
@property (nonatomic,readwrite,assign,getter=delegate,setter=setDelegate:) id <IPWorksHTTPDelegate> delegate;
...
@property (nonatomic,readwrite,assign,getter=allowHTTPCompression,setter=setAllowHTTPCompression:) BOOL allowHTTPCompression NS_SWIFT_NAME(allowHTTPCompression);
- (BOOL)allowHTTPCompression NS_SWIFT_NAME(allowHTTPCompression());
- (void)setAllowHTTPCompression:(BOOL)newAllowHTTPCompression NS_SWIFT_NAME(setAllowHTTPCompression(_:));
...
@property (nonatomic,readwrite,assign,getter=HTTPVersion,setter=setHTTPVersion:) NSString* HTTPVersion NS_SWIFT_NAME(HTTPVersion);
- (NSString*)HTTPVersion NS_SWIFT_NAME(HTTPVersion());
- (void)setHTTPVersion:(NSString*)newHTTPVersion NS_SWIFT_NAME(setHTTPVersion(_:));
...
@property (nonatomic,readwrite,assign,getter=range,setter=setRange:) NSString* range NS_SWIFT_NAME(range);
- (NSString*)range NS_SWIFT_NAME(range());
- (void)setRange:(NSString*)newRange NS_SWIFT_NAME(setRange(_:));
...
@property (nonatomic,readwrite,assign,getter=URLPath,setter=setURLPath:) NSString* URLPath NS_SWIFT_NAME(URLPath);
- (NSString*)URLPath NS_SWIFT_NAME(URLPath());
- (void)setURLPath:(NSString*)newURLPath NS_SWIFT_NAME(setURLPath(_:));

@property (nonatomic,readwrite,assign,getter=URLPort,setter=setURLPort:) int URLPort NS_SWIFT_NAME(URLPort);
- (int)URLPort NS_SWIFT_NAME(URLPort());
- (void)setURLPort:(int)newURLPort NS_SWIFT_NAME(setURLPort(_:));

@property (nonatomic,readwrite,assign,getter=URLScheme,setter=setURLScheme:) NSString* URLScheme NS_SWIFT_NAME(URLScheme);
- (NSString*)URLScheme NS_SWIFT_NAME(URLScheme());
- (void)setURLScheme:(NSString*)newURLScheme NS_SWIFT_NAME(setURLScheme(_:));

@property (nonatomic,readwrite,assign,getter=URLServer,setter=setURLServer:) NSString* URLServer NS_SWIFT_NAME(URLServer);
- (NSString*)URLServer NS_SWIFT_NAME(URLServer());
- (void)setURLServer:(NSString*)newURLServer NS_SWIFT_NAME(setURLServer(_:));
...
- (void)head:(NSString*)URL NS_SWIFT_NAME(head(_:));
