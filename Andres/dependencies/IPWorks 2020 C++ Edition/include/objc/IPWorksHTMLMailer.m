...
#if __cplusplus
#define HTMLMailer_EXTERN extern "C"
#else
#define HTMLMailer_EXTERN extern
#endif

HTMLMailer_EXTERN void* IPWorks_EvtStr(void* lpEvtStr, int esid, void* val, int opt);
HTMLMailer_EXTERN void* IPWorks_HTMLMailer_Create(void* lpSink, void* lpContext, char* lpOemKey, int opts);
HTMLMailer_EXTERN int   IPWorks_HTMLMailer_Destroy(void* lpObj);
HTMLMailer_EXTERN int   IPWorks_HTMLMailer_CheckIndex(void* lpObj, int propid, int arridx);
HTMLMailer_EXTERN void* IPWorks_HTMLMailer_Get(void* lpObj, int propid, int arridx, int* lpcbVal, long long* lpllVal);
HTMLMailer_EXTERN int   IPWorks_HTMLMailer_Set(void* lpObj, int propid, int arridx, void* val, int cbVal);
HTMLMailer_EXTERN int   IPWorks_HTMLMailer_Do(void* lpObj, int methid, int cparam, void* param[], int cbparam[], long long* lpllVal);
HTMLMailer_EXTERN char* IPWorks_HTMLMailer_GetLastError(void* lpObj);
HTMLMailer_EXTERN int   IPWorks_HTMLMailer_GetLastErrorCode(void* lpObj);
HTMLMailer_EXTERN int   IPWorks_HTMLMailer_SetLastErrorAndCode(void* lpObj, int code, char* message);
HTMLMailer_EXTERN char* IPWorks_HTMLMailer_GetEventError(void* lpObj);
HTMLMailer_EXTERN int   IPWorks_HTMLMailer_GetEventErrorCode(void* lpObj);
HTMLMailer_EXTERN int   IPWorks_HTMLMailer_SetEventErrorAndCode(void* lpObj, int code, char* message);

static void HTMLMailer_cCallBack(CFSocketRef s, CFSocketCallBackType ct, CFDataRef addr, const void *data, void *info) {
  void* param[1] = {(void*)(long)CFSocketGetNative(s)};
  IPWorks_HTMLMailer_Do(info, 2002/*MID_DOSOCKETEVENTS*/, 1, param, 0, nil);
}
...
static int HTMLMailer_cSink(id lpObj, int event_id, int cparam, void* param[], int cbparam[]) {
  IPWorksHTMLMailer* ctl = (IPWorksHTMLMailer*)lpObj;
  ...
  switch (event_id) {
    ...
    case 2001 /*EID_ASYNCSELECT*/: {
      ...
      if (!param[2]) {
        void* notifier = (void*)CFSocketCreateWithNative(NULL, (CFSocketNativeHandle)((unsigned long)param[0]), evtflags, HTMLMailer_cCallBack, &ctx);
    ...
    case 2003 /*EID_SHOWTRAILLICMSGFORIOS*/: {
      ...
      UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"IPWorks 2020 (HTMLMailer)" message:msg delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
      [myAlert show];
      return 1;
    ...
    case 5 /*EID_SSLSERVERAUTHENTICATION*/: {
...
@implementation IPWorksHTMLMailer

+ (IPWorksHTMLMailer*)htmlmailer
{
#if __has_feature(objc_arc)
  return [[IPWorksHTMLMailer alloc] init];
#else
  return [[[IPWorksHTMLMailer alloc] init] autorelease];
#endif
}
...
#if __has_feature(objc_arc)
  m_pObj = IPWorks_HTMLMailer_Create((void*)HTMLMailer_cSink, (__bridge void*)self, (char *)"\1\1\1MAC\1\1\1", 0);
#else
  m_pObj = IPWorks_HTMLMailer_Create((void*)HTMLMailer_cSink, self, (char *)"\1\1\1MAC\1\1\1", 0);
#endif
  if (m_pObj) IPWorks_HTMLMailer_Do(m_pObj, 2001/*MID_ENABLEASYNCEVENTS*/, 0, 0, 0, nil);
...
- (NSString*)lastError
{
  return [NSString stringWithCString:(const char*)IPWorks_HTMLMailer_GetLastError(m_pObj) encoding:[self innerGetCodePage]];
}
...
- (int)eventErrorCode
{
  return IPWorks_HTMLMailer_GetEventErrorCode(m_pObj);
}
...
{
  int len = 0;
  void* val = IPWorks_HTMLMailer_Get(m_pObj, 2011, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj)) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)setRuntimeLicense:(NSString*)newRuntimeLicense
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 2011, 0, val, len);
  if (ret_code) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)VERSION
{
  void* val = IPWorks_HTMLMailer_Get(m_pObj, 0, 0, 0, nil);
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 1, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}

- (void)setAttachmentCount:(int)newAttachmentCount
{
  void *val = (void*)(long)newAttachmentCount;
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 1, 0, val, 0);
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 2, attachmentIndex, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newAttachmentFile];
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 2, attachmentIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 3, attachmentIndex, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newAttachmentName];
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 3, attachmentIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 4, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setAuthMechanism:(int)newAuthMechanism
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 4, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 5, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setBCc:(NSString*)newBCc
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 5, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 6, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setCc:(NSString*)newCc
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 6, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)setCommand:(NSString*)newCommand
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 7, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 8, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setConnected:(BOOL)newConnected
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 8, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 9, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setDeliveryNotificationTo:(NSString*)newDeliveryNotificationTo
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 9, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 10, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setFirewallAutoDetect:(BOOL)newFirewallAutoDetect
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 10, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 11, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFirewallType:(int)newFirewallType
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 11, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 12, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallHost:(NSString*)newFirewallHost
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 12, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 13, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallPassword:(NSString*)newFirewallPassword
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 13, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 14, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFirewallPort:(int)newFirewallPort
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 14, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 15, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallUser:(NSString*)newFirewallUser
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 15, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 16, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFrom:(NSString*)newFrom
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 16, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 17, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newHTMLFile];
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 17, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 18, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 19, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  void *val = (void*)(long)newImageCount;
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 19, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 20, imageIndex, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
{
  int len = (int)[newImageData lengthOfBytesUsingEncoding:[self innerGetCodePage]];
  void *val = (void*)[self nsstringToCString:newImageData];
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 20, imageIndex, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSData*)imageDataB:(int)imageIndex
{
  int len = 0;
  void* val = IPWorks_HTMLMailer_Get(m_pObj, 20, imageIndex, &len, nil);
...
- (void)setImageDataB:(int)imageIndex :(NSData*)newImageData
{
  int len = (int)[newImageData length];
  void *val = (void*)[newImageData bytes];
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 20, imageIndex, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 21, imageIndex, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newImageFile];
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 21, imageIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)imageId:(int)imageIndex
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 22, imageIndex, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}

- (void)setImageId:(int)imageIndex:(NSString*)newImageId
{
  void *val = (void*)[self nsstringToCString:newImageId];
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 22, imageIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)imageType:(int)imageIndex
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 23, imageIndex, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}

- (void)setImageType:(int)imageIndex:(NSString*)newImageType
{
  void *val = (void*)[self nsstringToCString:newImageType];
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 23, imageIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 24, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setImportance:(int)newImportance
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 24, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 25, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 26, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setLocalHost:(NSString*)newLocalHost
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 26, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 27, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setMailPort:(int)newMailPort
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 27, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 28, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setMailServer:(NSString*)newMailServer
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 28, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 29, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setMessageDate:(NSString*)newMessageDate
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 29, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 30, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setMessageHTML:(NSString*)newMessageHTML
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 30, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 31, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setMessageId:(NSString*)newMessageId
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 31, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 32, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setMessageRecipientCount:(int)newMessageRecipientCount
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 32, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 33, recipientIndex, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setMessageRecipientAddress:(int)recipientIndex:(NSString*)newMessageRecipientAddress
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 33, recipientIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 34, recipientIndex, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setMessageRecipientName:(int)recipientIndex:(NSString*)newMessageRecipientName
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 34, recipientIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 35, recipientIndex, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setMessageRecipientOptions:(int)recipientIndex:(NSString*)newMessageRecipientOptions
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 35, recipientIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 36, recipientIndex, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setMessageRecipientType:(int)recipientIndex:(int)newMessageRecipientType
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 36, recipientIndex, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 37, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setMessageText:(NSString*)newMessageText
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 37, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 38, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setOtherHeaders:(NSString*)newOtherHeaders
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 38, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 39, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
{
  void *val = (void*)(long)(newParseHTML ? 1 : 0);
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 39, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 40, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setPassword:(NSString*)newPassword
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 40, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 41, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setPriority:(int)newPriority
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 41, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 42, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setReadReceiptTo:(NSString*)newReadReceiptTo
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 42, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 43, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setReplyTo:(NSString*)newReplyTo
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 43, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 44, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setSendTo:(NSString*)newSendTo
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 44, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 45, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setSensitivity:(int)newSensitivity
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 45, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 46, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setSSLAcceptServerCertEncoded:(NSString*)newSSLAcceptServerCertEncoded
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 46, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 47, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertEncoded:(NSString*)newSSLCertEncoded
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 47, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 48, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertStore:(NSString*)newSSLCertStore
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 48, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 49, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertStorePassword:(NSString*)newSSLCertStorePassword
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 49, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 50, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setSSLCertStoreType:(int)newSSLCertStoreType
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 50, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 51, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setSSLCertSubject:(NSString*)newSSLCertSubject
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 51, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 52, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setSSLEnabled:(BOOL)newSSLEnabled
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 52, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 53, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 54, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setSSLStartMode:(int)newSSLStartMode
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 54, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 55, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setSubject:(NSString*)newSubject
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 55, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 56, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setTimeout:(int)newTimeout
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 56, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_HTMLMailer_Get(m_pObj, 57, 0, &len, nil);
  if (IPWorks_HTMLMailer_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setUser:(NSString*)newUser
{
  ...
  int ret_code = IPWorks_HTMLMailer_Set(m_pObj, 57, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)addAttachment:(NSString*)fileName
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 2, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (NSString*)config:(NSString*)configurationString
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 3, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)connect
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 4, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)disconnect
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 5, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)doEvents
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 6, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)interrupt
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 7, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)processQueue:(NSString*)queueDir
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 8, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (NSString*)queue:(NSString*)queueDir
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 9, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)param[1] encoding:[self innerGetCodePage]];
}
...
- (void)reset
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 10, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)resetHeaders
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 11, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)send
{
  ...
  int ret_code = IPWorks_HTMLMailer_Do(m_pObj, 12, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (NSStringEncoding)innerGetCodePage {
  int len = 0;
  int codePage = (int)(long)IPWorks_HTMLMailer_Get(m_pObj, 2010, 0, &len, nil);
...
- (void)reportEventException:(NSException*)ex :(NSString*)event :(BOOL)reFire {
  ...
  IPWorks_HTMLMailer_SetEventErrorAndCode(m_pObj, -1, [self nsstringToCString:msg]);
