...
@protocol IPWorksSMTPDelegate <NSObject>
@optional
...
- (void)onExpand:(NSString*)address NS_SWIFT_NAME(onExpand(_:));
...
@interface IPWorksSMTP : NSObject {
  @public void* m_pObj;
  @public CFMutableArrayRef m_rNotifiers;
  __unsafe_unretained id <IPWorksSMTPDelegate> m_delegate;
  BOOL m_raiseNSException;
  BOOL m_delegateHasConnectionStatus;
  BOOL m_delegateHasEndTransfer;
  BOOL m_delegateHasError;
  BOOL m_delegateHasExpand;
...
@property (nonatomic,readwrite,assign,getter=delegate,setter=setDelegate:) id <IPWorksSMTPDelegate> delegate;
...
@property (nonatomic,readwrite,assign,getter=allowExtensions,setter=setAllowExtensions:) BOOL allowExtensions NS_SWIFT_NAME(allowExtensions);
- (BOOL)allowExtensions NS_SWIFT_NAME(allowExtensions());
- (void)setAllowExtensions:(BOOL)newAllowExtensions NS_SWIFT_NAME(setAllowExtensions(_:));
...
@property (nonatomic,readwrite,assign,getter=returnPath,setter=setReturnPath:) NSString* returnPath NS_SWIFT_NAME(returnPath);
- (NSString*)returnPath NS_SWIFT_NAME(returnPath());
- (void)setReturnPath:(NSString*)newReturnPath NS_SWIFT_NAME(setReturnPath(_:));
...
- (void)expand:(NSString*)emailAddress NS_SWIFT_NAME(expand(_:));
...
- (void)sendToTerminalAndEmail NS_SWIFT_NAME(sendToTerminalAndEmail());
- (void)sendToTerminalOnly NS_SWIFT_NAME(sendToTerminalOnly());
- (void)sendToTerminalOrEmail NS_SWIFT_NAME(sendToTerminalOrEmail());
- (void)verify:(NSString*)emailAddress NS_SWIFT_NAME(verify(_:));
