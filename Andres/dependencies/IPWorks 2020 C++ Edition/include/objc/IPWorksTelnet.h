...
@protocol IPWorksTelnetDelegate <NSObject>
@optional
- (void)onCommand:(int)commandCode NS_SWIFT_NAME(onCommand(_:));
...
- (void)onDataIn:(NSData*)text NS_SWIFT_NAME(onDataIn(_:));
- (void)onDisconnected:(int)statusCode :(NSString*)description NS_SWIFT_NAME(onDisconnected(_:_:));
- (void)onDo:(int)optionCode NS_SWIFT_NAME(onDo(_:));
- (void)onDont:(int)optionCode NS_SWIFT_NAME(onDont(_:));
...
- (void)onSubOption:(NSData*)subOption NS_SWIFT_NAME(onSubOption(_:));
- (void)onWill:(int)optionCode NS_SWIFT_NAME(onWill(_:));
- (void)onWont:(int)optionCode NS_SWIFT_NAME(onWont(_:));
@end

@interface IPWorksTelnet : NSObject {
  @public void* m_pObj;
  @public CFMutableArrayRef m_rNotifiers;
  __unsafe_unretained id <IPWorksTelnetDelegate> m_delegate;
  BOOL m_raiseNSException;
  BOOL m_delegateHasCommand;
  BOOL m_delegateHasConnected;
  BOOL m_delegateHasConnectionStatus;
  BOOL m_delegateHasDataIn;
  BOOL m_delegateHasDisconnected;
  BOOL m_delegateHasDo;
  BOOL m_delegateHasDont;
  BOOL m_delegateHasError;
  BOOL m_delegateHasReadyToSend;
  BOOL m_delegateHasSSLServerAuthentication;
  BOOL m_delegateHasSSLStatus;
  BOOL m_delegateHasSubOption;
  BOOL m_delegateHasWill;
  BOOL m_delegateHasWont;
}
...
@property (nonatomic,readwrite,assign,getter=delegate,setter=setDelegate:) id <IPWorksTelnetDelegate> delegate;
...
@property (nonatomic,readwrite,assign,getter=command,setter=setCommand:) int command NS_SWIFT_NAME(command);
- (int)command NS_SWIFT_NAME(command());
- (void)setCommand:(int)newCommand NS_SWIFT_NAME(setCommand(_:));
...
@property (nonatomic,readwrite,assign,getter=dontOption,setter=setDontOption:) int dontOption NS_SWIFT_NAME(dontOption);
- (int)dontOption NS_SWIFT_NAME(dontOption());
- (void)setDontOption:(int)newDontOption NS_SWIFT_NAME(setDontOption(_:));

@property (nonatomic,readwrite,assign,getter=doOption,setter=setDoOption:) int doOption NS_SWIFT_NAME(doOption);
- (int)doOption NS_SWIFT_NAME(doOption());
- (void)setDoOption:(int)newDoOption NS_SWIFT_NAME(setDoOption(_:));

@property (nonatomic,readwrite,assign,getter=doSubOption,setter=setDoSubOption:) NSString* doSubOption NS_SWIFT_NAME(doSubOption);
- (NSString*)doSubOption NS_SWIFT_NAME(doSubOption());
- (void)setDoSubOption:(NSString*)newDoSubOption NS_SWIFT_NAME(setDoSubOption(_:));

@property (nonatomic,readwrite,assign,getter=doSubOptionB,setter=setDoSubOptionB:) NSData* doSubOptionB NS_SWIFT_NAME(doSubOptionB);
- (NSData*)doSubOptionB NS_SWIFT_NAME(doSubOptionB());
- (void)setDoSubOptionB :(NSData*)newDoSubOption NS_SWIFT_NAME(setDoSubOptionB(_:));
...
@property (nonatomic,readwrite,assign,getter=transparent,setter=setTransparent:) BOOL transparent NS_SWIFT_NAME(transparent);
- (BOOL)transparent NS_SWIFT_NAME(transparent());
- (void)setTransparent:(BOOL)newTransparent NS_SWIFT_NAME(setTransparent(_:));

@property (nonatomic,readwrite,assign,getter=urgentData,setter=setUrgentData:) NSString* urgentData NS_SWIFT_NAME(urgentData);
- (NSString*)urgentData NS_SWIFT_NAME(urgentData());
- (void)setUrgentData:(NSString*)newUrgentData NS_SWIFT_NAME(setUrgentData(_:));

@property (nonatomic,readwrite,assign,getter=urgentDataB,setter=setUrgentDataB:) NSData* urgentDataB NS_SWIFT_NAME(urgentDataB);
- (NSData*)urgentDataB NS_SWIFT_NAME(urgentDataB());
- (void)setUrgentDataB :(NSData*)newUrgentData NS_SWIFT_NAME(setUrgentDataB(_:));

@property (nonatomic,readwrite,assign,getter=willOption,setter=setWillOption:) int willOption NS_SWIFT_NAME(willOption);
- (int)willOption NS_SWIFT_NAME(willOption());
- (void)setWillOption:(int)newWillOption NS_SWIFT_NAME(setWillOption(_:));

@property (nonatomic,readwrite,assign,getter=wontOption,setter=setWontOption:) int wontOption NS_SWIFT_NAME(wontOption);
- (int)wontOption NS_SWIFT_NAME(wontOption());
- (void)setWontOption:(int)newWontOption NS_SWIFT_NAME(setWontOption(_:));

  /* Methods */

- (NSString*)config:(NSString*)configurationString NS_SWIFT_NAME(config(_:));
- (void)connect:(NSString*)host NS_SWIFT_NAME(connect(_:));
