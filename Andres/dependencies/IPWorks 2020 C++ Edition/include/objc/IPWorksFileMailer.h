...
@protocol IPWorksFileMailerDelegate <NSObject>
@optional
...
@interface IPWorksFileMailer : NSObject {
  @public void* m_pObj;
  @public CFMutableArrayRef m_rNotifiers;
  __unsafe_unretained id <IPWorksFileMailerDelegate> m_delegate;
...
@property (nonatomic,readwrite,assign,getter=delegate,setter=setDelegate:) id <IPWorksFileMailerDelegate> delegate;
