...
#if __cplusplus
#define Rexec_EXTERN extern "C"
#else
#define Rexec_EXTERN extern
#endif

Rexec_EXTERN void* IPWorks_EvtStr(void* lpEvtStr, int esid, void* val, int opt);
Rexec_EXTERN void* IPWorks_Rexec_Create(void* lpSink, void* lpContext, char* lpOemKey, int opts);
Rexec_EXTERN int   IPWorks_Rexec_Destroy(void* lpObj);
Rexec_EXTERN int   IPWorks_Rexec_CheckIndex(void* lpObj, int propid, int arridx);
Rexec_EXTERN void* IPWorks_Rexec_Get(void* lpObj, int propid, int arridx, int* lpcbVal, long long* lpllVal);
Rexec_EXTERN int   IPWorks_Rexec_Set(void* lpObj, int propid, int arridx, void* val, int cbVal);
Rexec_EXTERN int   IPWorks_Rexec_Do(void* lpObj, int methid, int cparam, void* param[], int cbparam[], long long* lpllVal);
Rexec_EXTERN char* IPWorks_Rexec_GetLastError(void* lpObj);
Rexec_EXTERN int   IPWorks_Rexec_GetLastErrorCode(void* lpObj);
Rexec_EXTERN int   IPWorks_Rexec_SetLastErrorAndCode(void* lpObj, int code, char* message);
Rexec_EXTERN char* IPWorks_Rexec_GetEventError(void* lpObj);
Rexec_EXTERN int   IPWorks_Rexec_GetEventErrorCode(void* lpObj);
Rexec_EXTERN int   IPWorks_Rexec_SetEventErrorAndCode(void* lpObj, int code, char* message);

static void Rexec_cCallBack(CFSocketRef s, CFSocketCallBackType ct, CFDataRef addr, const void *data, void *info) {
  void* param[1] = {(void*)(long)CFSocketGetNative(s)};
  IPWorks_Rexec_Do(info, 2002/*MID_DOSOCKETEVENTS*/, 1, param, 0, nil);
}
...
static int Rexec_cSink(id lpObj, int event_id, int cparam, void* param[], int cbparam[]) {
  IPWorksRexec* ctl = (IPWorksRexec*)lpObj;
  ...
  switch (event_id) {
    ...
    case 2001 /*EID_ASYNCSELECT*/: {
      ...
      if (!param[2]) {
        void* notifier = (void*)CFSocketCreateWithNative(NULL, (CFSocketNativeHandle)((unsigned long)param[0]), evtflags, Rexec_cCallBack, &ctx);
    ...
    case 2003 /*EID_SHOWTRAILLICMSGFORIOS*/: {
      ...
      UIAlertView *myAlert = [[UIAlertView alloc] initWithTitle:@"IPWorks 2020 (Rexec)" message:msg delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
      [myAlert show];
      return 1;
...
@implementation IPWorksRexec

+ (IPWorksRexec*)rexec
{
#if __has_feature(objc_arc)
  return [[IPWorksRexec alloc] init];
#else
  return [[[IPWorksRexec alloc] init] autorelease];
#endif
}
...
#if __has_feature(objc_arc)
  m_pObj = IPWorks_Rexec_Create((void*)Rexec_cSink, (__bridge void*)self, (char *)"\1\1\1MAC\1\1\1", 0);
#else
  m_pObj = IPWorks_Rexec_Create((void*)Rexec_cSink, self, (char *)"\1\1\1MAC\1\1\1", 0);
#endif
  if (m_pObj) IPWorks_Rexec_Do(m_pObj, 2001/*MID_ENABLEASYNCEVENTS*/, 0, 0, 0, nil);
...
- (NSString*)lastError
{
  return [NSString stringWithCString:(const char*)IPWorks_Rexec_GetLastError(m_pObj) encoding:[self innerGetCodePage]];
}
...
- (int)eventErrorCode
{
  return IPWorks_Rexec_GetEventErrorCode(m_pObj);
}

- (id <IPWorksRexecDelegate>)delegate
{
  return m_delegate;
}

- (void) setDelegate:(id <IPWorksRexecDelegate>)anObject
{
...
{
  int len = 0;
  void* val = IPWorks_Rexec_Get(m_pObj, 2011, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj)) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)setRuntimeLicense:(NSString*)newRuntimeLicense
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 2011, 0, val, len);
  if (ret_code) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}

- (NSString*)VERSION
{
  void* val = IPWorks_Rexec_Get(m_pObj, 0, 0, 0, nil);
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 1, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 2, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setCommand:(NSString*)newCommand
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 2, 0, val, 0);
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 3, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setConnected:(BOOL)newConnected
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 3, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 4, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 5, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)setEOL:(NSString*)newEOL
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 5, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 6, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setErrEOL:(NSString*)newErrEOL
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 6, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 7, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 8, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return val ? YES : NO;
}
...
- (void)setFirewallAutoDetect:(BOOL)newFirewallAutoDetect
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 8, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 9, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFirewallType:(int)newFirewallType
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 9, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 10, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallHost:(NSString*)newFirewallHost
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 10, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 11, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallPassword:(NSString*)newFirewallPassword
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 11, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 12, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setFirewallPort:(int)newFirewallPort
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 12, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 13, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setFirewallUser:(NSString*)newFirewallUser
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 13, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 14, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setLocalHost:(NSString*)newLocalHost
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 14, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 15, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setLocalPort:(int)newLocalPort
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 15, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 16, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setRemoteHost:(NSString*)newRemoteHost
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 16, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 17, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
{
  void *val = (void*)[self nsstringToCString:newRemotePassword];
  int ret_code = IPWorks_Rexec_Set(m_pObj, 17, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 18, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setRemotePort:(int)newRemotePort
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 18, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 19, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [NSString stringWithCString:(const char*)val encoding:[self innerGetCodePage]];
}
...
- (void)setRemoteUser:(NSString*)newRemoteUser
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 19, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 20, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
- (void)setStdin:(NSString*)newStdin
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 21, 0, val, len);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 22, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return [[NSString alloc] initWithBytes:val length:len encoding:[self innerGetCodePage]];
}
...
{
  int len = 0;
  void* val=IPWorks_Rexec_Get(m_pObj, 23, 0, &len, nil);
  if (IPWorks_Rexec_GetLastErrorCode(m_pObj) && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
  return (int)(long)val;
}
...
- (void)setTimeout:(int)newTimeout
{
  ...
  int ret_code = IPWorks_Rexec_Set(m_pObj, 23, 0, val, 0);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (NSString*)config:(NSString*)configurationString
{
  ...
  int ret_code = IPWorks_Rexec_Do(m_pObj, 2, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
...
- (void)disconnect
{
  ...
  int ret_code = IPWorks_Rexec_Do(m_pObj, 3, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)doEvents
{
  ...
  int ret_code = IPWorks_Rexec_Do(m_pObj, 4, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)execute:(NSString*)command
{
  ...
  int ret_code = IPWorks_Rexec_Do(m_pObj, 5, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)interrupt
{
  ...
  int ret_code = IPWorks_Rexec_Do(m_pObj, 6, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)reset
{
  ...
  int ret_code = IPWorks_Rexec_Do(m_pObj, 7, 0, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (void)send:(NSData*)text
{
  ...
  int ret_code = IPWorks_Rexec_Do(m_pObj, 8, 1, param, cbparam, nil);
  if (ret_code && m_raiseNSException) [NSException raise:[self lastError] format:@"%@", [self lastError]];
}
...
- (NSStringEncoding)innerGetCodePage {
  int len = 0;
  int codePage = (int)(long)IPWorks_Rexec_Get(m_pObj, 2010, 0, &len, nil);
...
- (void)reportEventException:(NSException*)ex :(NSString*)event :(BOOL)reFire {
  ...
  IPWorks_Rexec_SetEventErrorAndCode(m_pObj, -1, [self nsstringToCString:msg]);
